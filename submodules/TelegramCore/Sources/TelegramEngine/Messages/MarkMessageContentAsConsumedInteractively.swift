...
// MARK: NAGRAM — optional account owner for pre-tombstone capture.
func markMessageContentAsConsumedRemotely(postbox: Postbox? = nil, transaction: Transaction, messageId: MessageId, consumeDate: Int32?) {
