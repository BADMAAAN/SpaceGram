...
private func seedNagramDemo(transaction: Transaction) {
    ...
    let me = demoUser(900001, "SpaceGram Demo")
    ...
    let channel = TelegramChannel(
        ...
        accessHash: nil, title: text("SpaceGram 灵感站", "SpaceGram Inspiration"), username: nil, photo: [],
    ...
    let chats: [(Peer, [(PeerId, String)], Int32)] = [
        (channel, [
            ...
            (channel.id, text("简洁的界面，自由的表达。\n在 SpaceGram，找到属于你的聊天方式。 ✨", "A clean interface. Room to be yourself.\nFind your own way to chat with SpaceGram. ✨"))
        ], 0),
        (lin, [
    ...
    for (chatIndex, chat) in chats.enumerated() {
        ...
        // MARK: SPACEGRAM - Xcode 26 Swift type-checker compatibility.
