...
private func seedNagramDemo(transaction: Transaction) {
    ...
    let me = demoUser(900001, "Qwengram Demo")
    ...
    let channel = TelegramChannel(
        ...
        accessHash: nil, title: text("Qwengram 灵感站", "Qwengram Inspiration"), username: nil, photo: [],
    ...
    let chats: [(Peer, [(PeerId, String)], Int32)] = [
        (channel, [
            ...
            (channel.id, text("简洁的界面，自由的表达。\n在 Qwengram，找到属于你的聊天方式。 ✨", "A clean interface. Room to be yourself.\nFind your own way to chat with Qwengram. ✨"))
        ], 0),
        (lin, [
