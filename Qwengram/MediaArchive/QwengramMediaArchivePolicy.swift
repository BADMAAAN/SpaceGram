...
public struct QwengramMediaArchivePolicy: Codable, Equatable {
    public static let storagePresets: [Int64] = [256, 512, 1024, 2048].map { $0 * 1024 * 1024 }
    public static let retentionPresets = [7, 30, 90]
    public static let `default` = QwengramMediaArchivePolicy(storageLimitBytes: 512 * 1024 * 1024, retentionDays: 30, automaticCleanup: true)
...
public struct QwengramMediaArchiveUsage {
    public let bytes: Int64
    public let assetCount: Int
    public let policy: QwengramMediaArchivePolicy
}
